...
S1_FNIRS_PATH = '/content/drive/MyDrive/eigen_blood/first_session/first_fnirs_log.csv'
S1_CGM_PATH = '/content/drive/MyDrive/eigen_blood/first_session/first_cgm_log.csv'
S1_CGM_COLUMN = 'Scan Glucose (mmol/L)'

# --- Session 2 Paths & Info ---
S2_FNIRS_PATH = '/content/drive/MyDrive/eigen_blood/second_session/second_fnirs_log.csv'
S2_CGM_PATH = '/content/drive/MyDrive/eigen_blood/second_session/second_cgm_log.csv'
...
def run_generalization_experiment(train_fnirs_path, train_cgm_path, train_cgm_col, test_fnirs_path, test_cgm_path, test_cgm_col, experiment_name):
    ...
    plots_folder = f"PLOTS_{experiment_name}"
...
# --- File Paths & Info ---
S1_FNIRS_PATH = '/content/drive/MyDrive/eigen_blood/first_session/fnirs_log.csv'
S1_CGM_PATH = '/content/drive/MyDrive/eigen_blood/first_session/cgm_log.csv'
S1_CGM_COLUMN = 'Scan Glucose (mmol/L)'

S2_FNIRS_PATH = '/content/drive/MyDrive/eigen_blood/second session/fnirs_log.csv'
S2_CGM_PATH = '/content/drive/MyDrive/eigen_blood/second session/cgm_log.csv'
S2_CGM_COLUMN = 'Scan Glucose (mmol/L)'
...
PLOTS_FOLDER = "fNIRS_CombinedTraining_Results"
os.makedirs(PLOTS_FOLDER, exist_ok=True)
